...
def test_generation_payload_matches_live_openapi(monkeypatch):
    ...
    event_id = provider._post_generation(
        {"path": "/tmp/video.mp4", "meta": {"_type": "gradio.FileData"}},
        {"path": "/tmp/image.png", "meta": {"_type": "gradio.FileData"}},
    )
    ...
    assert payload == {
        "input_video": {"path": "/tmp/video.mp4", "meta": {"_type": "gradio.FileData"}},
        "max_duration_s": 2,
        "edited_frame": {"path": "/tmp/image.png", "meta": {"_type": "gradio.FileData"}},
...
def test_live_rest_flow_uses_current_api(monkeypatch, tmp_path):
    ...
    assert payload == {
        "input_video": {"path": "/tmp/reference.mp4", "meta": {"_type": "gradio.FileData"}},
        "max_duration_s": 2,
        "edited_frame": {"path": "/tmp/character.png", "meta": {"_type": "gradio.FileData"}},
        "rc_str": "Pose Retarget",
        "resolution_choice": "Low Res",
    }
